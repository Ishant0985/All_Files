...
const googleSignInButton = document.getElementById("sign-in-google"); // Google Sign-In button
...
googleSignInButton.addEventListener("click", function() {
  ...
  signInWithPopup(auth, provider)
    ...
    .catch((error) => {
      const errorCode = error.code;
      const errorMessage = error.message;
      console.log("Error occurred during Google sign-in. Try again.");
      window.alert("Error occurred during Google sign-in. Try again.");
    });
});
